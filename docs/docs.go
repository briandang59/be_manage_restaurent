    ...
    "paths": {
        ...
        "/availibilities": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.Availibility"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dữ liệu availibility",
                        "name": "availibility",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/ingredients": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dữ liệu nguyên liệu",
                        "name": "ingredient",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/order-items": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dữ liệu order item",
                        "name": "orderItem",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/permissions": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dữ liệu permission",
                        "name": "permission",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/shifts": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dữ liệu ca làm việc",
                        "name": "shift",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/shifts-chedules": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.ShiftSchedule"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dữ liệu lịch ca làm việc",
                        "name": "shiftSchedules",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "model.Availibility": {
            ...
            "properties": {
                ...
                "day_of_week": {
                    "$ref": "#/definitions/enum.DayOfWeek"
                },
                "employee": {
                    "$ref": "#/definitions/model.Employee"
                },
        ...
        "model.Employee": {
            ...
            "properties": {
                ...
                "schedule_type": {
                    "$ref": "#/definitions/enum.EmployeeScheduleType"
                },
                "updated_at": {
                    "type": "string"
                }
        ...
        "model.Order": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/enum.OrderEnum"
                },
                "table": {
                    "$ref": "#/definitions/model.Table"
                },
        ...
        "model.Ticket": {
            ...
            "properties": {
                ...
                "ticket_type": {
                    "$ref": "#/definitions/enum.TicketType"
                },
                "unit": {
                    "type": "string"
                },
