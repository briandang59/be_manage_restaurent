...
func (s *TicketService) Create(ticket *model.Ticker) error {
	return s.repo.Create(ticket)
}

func (s *TicketService) GetByID(id uint) (*model.Ticker, error) {
...
func (s *TicketService) List(offset, limit int) ([]model.Ticker, int64, error) {
